...
def cargar_estilos():
    ...
    <style>
        ...
        .stApp {
            ...
            background-image: radial-gradient(circle at 20% 30%, rgba(0, 229, 255, 0.05) 0%, transparent 45%), radial-gradient(circle at 75% 70%, rgba(156, 39, 176, 0.06) 0%, transparent 50%), radial-gradient(white 1px, transparent 1px), radial-gradient(white 1.5px, transparent 1.5px);
        ...
        /* === ESCUDO DE PRIVACIDAD DE FUERZA BRUTA === */
        #MainMenu, footer, header { visibility: hidden !important; display: none !important; }
        
        /* Oculta específicamente el icono de usuario de GitHub y barra de desarrollador */
        [data-testid="stStatusWidget"], .st-emotion-cache-1avcm0n, [data-testid="stToolbar"] {
            visibility: hidden !important;
            display: none !important;
        }
        
        /* Bloqueo total del contenedor de usuario en la esquina */
...
def obtener_svg_atomo(modelo_nombre):
    if "Dalton" in modelo_nombre: return "<svg viewBox='0 0 100 100' width='90' height='90'><circle cx='50' cy='50' r='34' fill='none' stroke='#90a4ae' stroke-width='2.5'/><circle cx='50' cy='50' r='31' fill='#90a4ae' opacity='0.15'/></svg>"
    ...
    else: return "<svg viewBox='0 0 100 100' width='90' height='90'><defs><radialGradient id='cloud' cx='50%' cy='50%' r='50%'><stop offset='0%' stop-color='#00e5ff' stop-opacity='0.8'/><stop offset='50%' stop-color='#00e5ff' stop-opacity='0.25'/><stop offset='100%' stop-color='#00e5ff' stop-opacity='0'/></radialGradient></defs><circle cx='50' cy='50' r='38' fill='url(#cloud)'/><circle cx='50' cy='4' fill='#ffffff'/></svg>"
...
def mezclar_memorama():
    contenido = [("Dalton (1810)", 1), ("Materia indivisible sin cargas", 1), ("Thomson (1897)", 2), ("Esfera positiva con electrones incrustados", 2), ("Rutherford (1911)", 3), ("Núcleo denso positivo y espacio vacío", 3), ("Bohr (1913)", 4), ("Órbitas circulares planas cuantizadas", 4), ("Schrödinger (1926)", 5), ("Orbitales 3D (Flexibilidad cuántica)", 5)]
